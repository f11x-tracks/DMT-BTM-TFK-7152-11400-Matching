...
class DMTTFKComparisonApp:
    ...
    def find_matching_points(self):
        ...
        # Apply radial adjustment to DMT thickness data (add 90 to points > 146mm radius)
        if len(self.matched_data) > 0:
            ...
            if num_adjusted > 0:
                # Add 90 Å to DMT thickness for points > 146mm radius
                self.matched_data.loc[radius_mask, 'DMT_Thickness'] += 90.0
                ...
                print(f"  Adjusted {num_adjusted} DMT thickness points (radius > 146mm) by +90 Å")
